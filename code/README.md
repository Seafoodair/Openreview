...
first ,we should download pre-training model ELECTRA-Small. Click the link (https://storage.googleapis.com/electra-data/electra_small.zip)to download to ../../data/sentiment analysis/
### generate model<br>
