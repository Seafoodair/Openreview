...
#bos1= pd.read_csv('E:\\超级账本教程\\Openreview论文修改\\Rebuttal.csv', delimiter=',',usecols=['id','reviewlevel','novel','motivation', 'arxiv','experiment', 'relatework', 'readable','score'])#这个缺动机
...
# X=bos2[1:,0:-1]
# bos2= genfromtxt('E:\\超级账本教程\\Openreview论文修改\\因果3.csv', delimiter=',')#这个动机
# X=bos2[1:,0:-1]
