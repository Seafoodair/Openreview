...
def dual_bert():
    ...
    print("池化后的情况",type(embedding1),type(embedding2),embedding1.shape,embedding2.shape)
    ...
    model.compile(loss='mean_squared_error', optimizer=opt,metrics=['accuracy'])#加个评测指标
